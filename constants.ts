...
export const ICONS: { [key: string]: (className: string) => React.ReactNode } = {
    ...
    sign: (className: string) => React.createElement('svg', {className, xmlns:"http://www.w3.org/2000/svg", fill:"none", viewBox:"0 0 24 24", strokeWidth:1.5, stroke:"currentColor"}, React.createElement('path', {strokeLinecap:"round", strokeLinejoin:"round", d:"M7.5 8.25L5.25 6H3.75v12H6v-6l1.5 1.5L9 18h2.25l-2.25-6 2.625-2.625a.75.75 0 0 0-.53-1.281H10.5l-2.25 2.25L7.5 8.25Z"}), React.createElement('path', {strokeLinecap:"round", strokeLinejoin:"round", d:"M13.5 12h3.75a2.25 2.25 0 0 1 2.25 2.25v4.5a2.25 2.25 0 0 1-2.25-2.25h-3.75a2.25 2.25 0 0 1-2.25-2.25v-4.5a2.25 2.25 0 0 1 2.25-2.25Z"})),
